...
public class AvatarMQContainer implements Container {
    ...
    public static final String AvatarMQConfigFilePath = "../conf/avatarmq-broker.xml";
...
//        AbstractApplicationContext context = new ClassPathXmlApplicationContext(AvatarMQConfigFilePath);
        AbstractApplicationContext context = new FileSystemXmlApplicationContext(AvatarMQConfigFilePath);
