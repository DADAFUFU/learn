...
public class MessageConnectPool extends GenericObjectPool<MessageConnectFactory> {
    ...
    private static String configPropertiesString = "../conf/avatarmq.messageconnect.properties";
    ...
    private MessageConnectPool() {
        try {
            ...
            InputStream inputStream = new FileInputStream(configPropertiesString);
